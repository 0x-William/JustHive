      ...
      <View style={{ height: CONTAINER_DIMS, width: CONTAINER_DIMS }}>
        <Order>
          {images.map((image, index) => {
            if (image !== null) {
              const initialRotate =
                images[index].editState.rotate + images[index].editStateModified.rotate;
              const initialScale =
                images[index].editState.scale * images[index].editStateModified.scale;
              const initialLeft = images[index].editState.left + images[index].editStateModified.left;
              const initialTop = images[index].editState.top + images[index].editStateModified.top;
